...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('|#countdown 3||亲|爱|的|点|点|宝|贝|#rectangle|虎|年|到|了|#rectangle|洋|洋|祝|点|点|虎|年|快|乐|#rectangle|新|的|一|年|#circle|祝|点|点|学|习|科|研|一|帆|风|顺|#rectangle|竞|赛|大|奖|拿|到|手|软|#rectangle|一|等|奖|学|金|收|入|囊|中|#circle|最重要|的是|#rectangle|也要|一直|一直|快乐|下去|♡|尽管|洋洋|还有|很多|缺点|#circle|但|洋洋|每天|都在|努力|变得更好|#circle|希望|有一天|可以|把|最好的|自己|给|点点|#circle|洋洋|的|愿|望|就是|成为|能让|点点|满意|能给|点点|幸福|的|男孩|#circle|洋洋|会|永远|陪着|点点|✌|还要和|点点|道一万次|晚安|✌|会|一直|爱着|点点|♡|永远|爱下去|♡');
    }
